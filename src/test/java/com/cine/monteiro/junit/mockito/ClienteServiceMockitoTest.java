...
public class ClienteServiceMockitoTest {
	...
	public void getUsersTest() throws UserException {
		when(repository.findAll()).thenReturn(Stream.of(new User("12388400430", "Tadeu", "99885564", LocalDate.now(), "testes@gmail.com", "teste123", "ROLE_USER"),
				new User("12388400420", "Marcelo", "99662354", LocalDate.now(), "testes2@gmail.com", "teste345", "ROLE_USER")).collect(Collectors.toList()));
	...
	public void getUsersByEmail() {
		...
		when(repository.findByEmail(email)).thenReturn((User) Stream.of(new User("12388400430", "Tadeu", "99885564", LocalDate.now(), "mockito123@gmail.com", "teste123", "ROLE_USER")).collect(Collectors.toList()));
	...
	public void saveUserTest() throws UserException {
		User user = new User("12388400430", "Tadeu", "99885564", LocalDate.now(), "mockito123@gmail.com", "teste123", "ROLE_USER");
